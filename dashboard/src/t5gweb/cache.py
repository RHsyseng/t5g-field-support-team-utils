...
def _build_card_data(card, jira_conn, cases, bugs, issues, escalations, details, time_now, cfg):
    # Generated by: Cursor
    ...
    return {
        ...
        "case_days_open": (
            ...
            - format_date(case_data["createdate"])
        ).days,
    ...
    for issue in issues_data:
        if "title" in issue.keys():
            try:
                ...
                logging.warning("Error processing issue %s: %s", issue.get("resourceKey", "unknown"), str(e))
                continue
